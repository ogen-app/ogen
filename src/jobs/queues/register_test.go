...
func TestAllWorkersSelfRegister(t *testing.T) {
	const wantWorkers = 18 // submit, poll, cancel, cleanup, reconcile, analytics, followers, bootstrap-profile, process-pdf, process-document, process-audio, process-image, process-url, send-email, cleanup-email-logs, cleanup-connect-sessions, detect-expiring-connections, cleanup-notifications
